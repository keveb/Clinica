function convertToUppercase(input) {//Función para que convierta la letras de CURP a mayusculas
...
$(document).ready(function() {
    $("#form").submit(function(event) {
        ...
        if (curp === '' || nombre === '' || apellido === '' || edad === '' || correo === '' || telefono === '' || direccion === '' || cedula === '') {
            ...
            success: function(response) {
                if (response == "ok") {
                    ...
                    Swal.fire({
                        ...
                        icon: "warning",
                        text: "El Doctor ya está registrado en la base de datos."
                    });
                }else if (response == "error") {
                    Swal.fire({
                        title: "Error",
                        icon: "error",
                        text: "No se pudo registrar al doctor. Inténtalo de nuevo más tarde."
                    });
                }
            }
        });
